...
export default function TimelineItem({ period, title, organization, bullets }: TimelineItemProps) {
  return (
    <div className="relative pl-8 pb-8 last:pb-0">
      ...
      {/* Dot */}
      <div className="absolute left-[-5px] top-1 w-3 h-3 rounded-full bg-zinc-500 dark:bg-zinc-400 border-2 border-slate-50 dark:border-zinc-900 ring-2 ring-zinc-300 dark:ring-zinc-600" />
