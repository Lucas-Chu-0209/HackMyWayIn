...
export default function TimelineItem({ period, title, organization, bullets }: TimelineItemProps) {
  return (
    <div className="relative pl-8 pb-8 last:pb-0">
      ...
      {/* Dot */}
      <div className="absolute left-[-5px] top-1 w-3 h-3 rounded-full bg-blue-600 border-2 border-white ring-2 ring-blue-200" />
      <p className="text-xs font-mono text-blue-600 mb-1">{period}</p>
