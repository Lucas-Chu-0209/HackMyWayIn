...
export default function Avatar() {
  return (
    <div className="relative flex items-center justify-center w-56 h-56 md:w-72 md:h-72 rounded-full bg-linear-to-br from-blue-400 to-blue-700 shadow-2xl select-none mx-auto">
