    ...
    <>
      ...
      <main className="bg-zinc-100 dark:bg-zinc-950">
        ...
        <div className="mx-auto grid w-full max-w-7xl gap-4 px-4 py-6 sm:px-6 lg:grid-cols-[minmax(0,1fr)_20rem] lg:px-8 xl:px-10">
          <article className="w-full max-w-4xl rounded-2xl border border-zinc-200 bg-white py-6 dark:border-white/10 dark:bg-zinc-900/50">
            ...
            <div className="prose prose-neutral dark:prose-invert max-w-none px-4 pt-4 sm:px-6 sm:pt-5">
              {post.content}
            </div>
          </article>
