              ...
              <section className="rounded-3xl bg-zinc-50/70 px-4 py-10 dark:bg-zinc-900/30 sm:px-5 lg:px-6">
                <div>
                  ...
                  <p className="mt-2 max-w-3xl text-sm leading-relaxed text-zinc-500 dark:text-zinc-400">
                    📍 The latest posts, learning notes, and personal write-ups are shared here!
                    <br />⚠️ Notes: Still in the early stages, not much content yet, but stay tuned for more updates! If you have any questions or suggestions, feel free to reach out through the contact links below ~!
                  </p>
                </div>
